...
function renderSection(projIndex) {
  ...
  allTodos.myProjects[projIndex].forEach((e) =>
    renderTodo(e.title, e.description, e.date, e.priority, e.index, e.projIndex)
  );
}
...
function editModal(index, projIndex) {
  ...
  document.querySelector("#todoTitle").value =
    allTodos.myProjects[projIndex][index].title;
  document.querySelector("#todoDesc").value =
    allTodos.myProjects[projIndex][index].description;
  document.querySelector("#todoDate").value =
    allTodos.myProjects[projIndex][index].date;
  document.querySelector("#todoPriority").value =
    allTodos.myProjects[projIndex][index].priority;
  document.querySelector("#projIndex").value =
    allTodos.myProjects[projIndex][index].index;
